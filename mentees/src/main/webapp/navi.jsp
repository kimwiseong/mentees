...
<div id="navi">
	<nav class="navBar">
      <ul>
        <li><a href="#" class="logo">mentees</a></li>
        <li><a href="#" class="noticePage">공지 사항</a></li>
        <li><a href="#" class="mentoRecruitment">멘토 모집</a></li>
        <li><a href="#" class="menteeRecruitment">멘티 모집</a></li>
