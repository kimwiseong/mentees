...
<section class="info">
  ...
  <h3 class="writer">작성자: <a href="<c:url value='searchMember?name=${ mentor.name }'/>"> ${mentor.name }</a></h3>
        ...
        <td width=70></td>
         ...
         <c:forEach items="${comments}" var="list">
          <tr>
            ...
            <td width=200><a href="<c:url value='searchMember?name=${list.name }'/>"> ${list.name }</a></td>
                         ...
                         <ul>
                             ...
                             <c:if test="${page.prev }">
                                ...
                                <c:forEach var="num" begin="${page.start }" end="${page.end }">
                                    ...
                                    <a href="readRecruit?id=${mentor.id }&pageNum=${num+1 }">${num+1 }</a></li>
                                </c:forEach>
