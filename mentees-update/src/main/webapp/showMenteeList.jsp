...
<section class="info">
  ...
  <h3 class="writer">작성자: <a href="<c:url value='searchMember?name=${study.name }'/>"> ${study.name }</a></h3>
  <h3 class="menteeTitle"> 제목 : ${study.title }</h3>
  <h3 class="content"></h3>
  <textarea cols="142" rows="15" class="contentInfo" readonly>${study.content }</textarea>
                         ...
                         <ul>
                             ...
                             <c:if test="${page.prev }">
                                ...
                                <c:forEach var="num" begin="${page.start }" end="${page.end }">
                                    ...
                                    <a href="readStudy?id=${study.id }&pageNum=${num+1 }">${num+1 }</a></li>
                                </c:forEach>
