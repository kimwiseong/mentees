...
<body>
  ...
  <h3 class="writer">작성자: <a href="<c:url value='searchMember?name=${notice.name }'/>"> ${notice.name }</a></h3>
  <h3 class="noticeTitle"> 제목 : ${notice.title }</h3>

  <textarea cols="142" rows="15" class="contentInfo" readonly>${notice.content }</textarea>
