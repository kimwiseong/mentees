...
<body>
   ...
   <button class="writeList" onclick="writeList(); return false;">글 작성</button>
    ...
    <table>
        <tr>
            <td><input type="search" name="query" placeholder="검색어를 입력해주세요." class="searchBox"></td>
            <td><input type="submit" value="검색" style="font-family: 'yg-jalnan';" class="searchButton"></td>
        </tr>
    </table> 
    </form>
        ...
        <tbody>
            ...
            <c:forEach items="${noticeList}" var="list">
              <tr>
                ...
                <td width="300px" align="center"><a href="<c:url value='readnotice?id=${ list.id }'/>">${list.title }</a></td>
